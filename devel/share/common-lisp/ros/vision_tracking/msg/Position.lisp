...
(cl:defmethod detected-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision_tracking-msg:detected-val is deprecated.  Use vision_tracking-msg:detected instead.")
  (detected m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Position>)))
  ...
  "08f7510425c59ccb0f8a2361634fcb13")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Position)))
  "Returns md5sum for a message object of type 'Position"
  "08f7510425c59ccb0f8a2361634fcb13")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Position>)))
  ...
  (cl:format cl:nil "bool detected~%uint16 position_x~%uint16 position_y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Position)))
  "Returns full string definition for message of type 'Position"
  (cl:format cl:nil "bool detected~%uint16 position_x~%uint16 position_y~%~%~%"))
